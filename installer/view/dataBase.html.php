...
<html>
  ...
  <body><br><br><br>
      ...
      <div class="page-header  text-center titulo">
        <h1><i class="glyphicon glyphicon-th-list"> Configuracion De la Base De Datos</i><br><small> Paso 1</small></h1>
    </div>
    ...
    <form action="index.php?step=3" method="POST">
      ...
      <input  type="submit" value="Continuar" class="btn btn-success btn-xs">
       <a class="btn btn-info btn-xs" href="ayuda.html.php">Necesita Ayuda Para Instalar?</a>
        </div>
