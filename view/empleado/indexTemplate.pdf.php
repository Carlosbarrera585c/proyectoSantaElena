...
$pdf->Cell(255,10,'REPORTE EMPLEADO',1,1,'C');
  ...
  $pdf->Cell(30,10,  utf8_decode("correo"),1);
  $pdf->Cell(35,10,  utf8_decode("identificacion"),1);
  $pdf->Ln();
foreach ($objEmpleado as $empleado){
  $pdf->Cell(10,10,  utf8_decode($empleado->$id),1);
  $pdf->Cell(30,10,  utf8_decode($empleado->$nomEmpleado),1);
  $pdf->Cell(20,10,  utf8_decode($empleado->$apellEmpleado),1);
  $pdf->Cell(20,10,  utf8_decode($empleado->$telefono),1);
  $pdf->Cell(20,10,  utf8_decode($empleado->$direccion),1);
