...
<form class="form-horizontal" role="form" method="post" action="<?php echo routing::getInstance()->getUrlWeb('empresa', ((isset($objEmpresa)) ? 'update' : 'create')) ?>">
    ...
    <div class="container container-fluid">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" value="<?php echo ((isset($objEmpresa) == true) ? $objEmpresa[0]->$nit : '') ?>" name="<?php echo empresaTableClass::getNameField(empresaTableClass::NIT, true) ?>" placeholder="<?php echo i18n::__('EnterTheNitCompany')?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-2 control-label" ><?php echo i18n::__('name') ?>:</label>
            <div class="col-lg-10">
                <input type="text" class="form-control" value="<?php echo ((isset($objEmpresa) == true) ? $objEmpresa[0]->$nom_empresa : '') ?>" name="<?php echo empresaTableClass::getNameField(empresaTableClass::NOM_EMPRESA, true) ?>" placeholder="<?php echo i18n::__('EnterTheCompanyName')?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-2 control-label" ><?php echo i18n::__('businessName') ?>:</label>
            <div class="col-lg-10">
                <input type="text" class="form-control" value="<?php echo ((isset($objEmpresa) == true) ? $objEmpresa[0]->$razon_social : '') ?>" name="<?php echo empresaTableClass::getNameField(empresaTableClass::RAZON_SOCIAL, true) ?>" placeholder="<?php echo i18n::__('EnterTheTradeNameOfTheCompany')?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-2 control-label"><?php echo i18n::__('direction') ?>:</label>
            <div class="col-lg-10">
                <input type="text" class="form-control" value="<?php echo ((isset($objEmpresa) == true) ? $objEmpresa[0]->$direccion : '') ?>" name="<?php echo empresaTableClass::getNameField(empresaTableClass::DIRECCION, true) ?>" placeholder="<?php echo i18n::__('EnterYourAddress')?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-2 control-label"><?php echo i18n::__('phone') ?>:</label>
            <div class="col-lg-10">
                <input type="text" class="form-control" value="<?php echo ((isset($objEmpresa) == true) ? $objEmpresa[0]->$telefono : '') ?>" name="<?php echo empresaTableClass::getNameField(empresaTableClass::TELEFONO, true) ?>" placeholder="<?php echo i18n::__('EnterYourPhone')?>">
            </div>
        </div>
        <div class="form-group">
