...
<form class="form-horizontal" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('aguas', ((isset($objAguas)) ? 'update' : 'create')) ?>">
    ...
    <?php endif ?>
        ...
        <div class="form-group <?php echo (session::getInstance()->hasFlash(aguasTableClass::getNameField(aguasTableClass::PH, true)) === true) ? 'has-error has-feedback' : '' ?>">
            <label for="<?php echo aguasTableClass::getNameField(aguasTableClass::PH, true) ?>" class="col-lg-2 control-label"><?php echo i18n::__('ph') ?>:</label>
            <div class="col-lg-10">
                <input id="<?php echo aguasTableClass::getNameField(aguasTableClass::PH, true) ?>" type="text" class="form-control"  value="<?php echo ((isset($objAguas) == true) ? $objAguas[0]->$ph : ((session::getInstance()->hasFlash(aguasTableClass::getNameField(aguasTableClass::PH, true)) === true) ? '' : (request::getInstance()->hasPost(aguasTableClass::getNameField(aguasTableClass::PH, true))) ? request::getInstance()->getPost(aguasTableClass::getNameField(aguasTableClass::PH, true)) : '' )) ?>" name="<?php echo aguasTableClass::getNameField(aguasTableClass::PH, true) ?>" placeholder="<?php echo i18n::__('ph') ?>">
        ...
        <div class="form-group <?php echo (session::getInstance()->hasFlash(aguasTableClass::getNameField(aguasTableClass::CLORO_RESIDUAL, true)) === true) ? 'has-error has-feedback' : '' ?>">
            <label for="<?php echo aguasTableClass::getNameField(aguasTableClass::CLORO_RESIDUAL, true) ?>" class="col-lg-2 control-label"><?php echo i18n::__('residualChlorine') ?>:</label>
            <div class="col-lg-10">
                <input id="<?php echo aguasTableClass::getNameField(aguasTableClass::CLORO_RESIDUAL, true) ?>" type="text" class="form-control"  value="<?php echo ((isset($objAguas) == true) ? $objAguas[0]->$cloro_residual : ((session::getInstance()->hasFlash(aguasTableClass::getNameField(aguasTableClass::CLORO_RESIDUAL, true)) === true) ? '' : (request::getInstance()->hasPost(aguasTableClass::getNameField(aguasTableClass::CLORO_RESIDUAL, true))) ? request::getInstance()->getPost(aguasTableClass::getNameField(aguasTableClass::CLORO_RESIDUAL, true)) : '' )) ?>" name="<?php echo aguasTableClass::getNameField(aguasTableClass::CLORO_RESIDUAL, true) ?>" placeholder="<?php echo i18n::__('residualChlorine') ?>">
                <?php if (session::getInstance()->hasFlash(aguasTableClass::getNameField(aguasTableClass::PH, true)) === true): ?>
                    <span class="glyphicon glyphicon-remove form-control-feedback"></span>
                <?php endif ?>
            </div>
