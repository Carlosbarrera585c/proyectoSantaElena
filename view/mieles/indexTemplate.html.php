            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" class="form-horizontal" id="reportFilterForm" action="<?php echo routing::getInstance()->getUrlWeb('mieles', 'report') ?>">
                        ...
                        <div class="form-group">
                            <label for="filterNumIdentificacion" class="col-sm-2 control-label"><?php echo i18n::__('operator') ?></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="filterNumIdentificacion" name="report[NumIdentificacion]" placeholder="<?php echo i18n::__('operator') ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="filterNumCeba" class="col-sm-2 control-label"><?php echo i18n::__('numberOfFattening') ?></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="filterNumCeba" name="report[NumCeba]" placeholder="<?php echo i18n::__('numberOfFattening') ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="filterCaja" class="col-sm-2 control-label"><?php echo i18n::__('box') ?></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="filterCaja" name="report[Caja]" placeholder="<?php echo i18n::__('box') ?>">
                            </div>
                        </div>
                    </form>
                </div>
