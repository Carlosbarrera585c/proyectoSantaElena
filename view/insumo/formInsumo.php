...
<?php view::includeHandlerMessage() ?>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" value="<?php echo ((isset($objInsu) == true) ? $objInsu[0]->$precio : '') ?>" id="<?php echo insumoTableClass::getNameField(insumoTableClass::PRECIO, true) ?>" type="text" class="frm-control" name="<?php echo insumoTableClass::getNameField(insumoTableClass::PRECIO, true) ?>" placeholder="Introduce el id tipo insumo">
            </div>
        </div>
        <div class="form-group">
