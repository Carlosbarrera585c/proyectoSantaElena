...
<form class="form-horizontal" method="post" action="<?php echo routing::getInstance()->getUrlWeb('insumo', ((isset($objInsu)) ? 'update' : 'create')) ?>">
    ...
    <div class="container container-fluid">    
        ...
        <div class="form-group">
            <label for="<?php echo insumoTableClass::getNameField(insumoTableClass::DESC_INSUMO, true) ?>" class="col-lg-2 control-label"><?php echo i18n::__('descriptionInput') ?>:</label>
            <div class="col-lg-10">
                <input type="text" class="form-control" value="<?php echo ((isset($objInsu) == true) ? $objInsu[0]->$desc_insumo : '') ?>" id="<?php echo insumoTableClass::getNameField(insumoTableClass::DESC_INSUMO, true) ?>" type="text" class="frm-control" name="<?php echo insumoTableClass::getNameField(insumoTableClass::DESC_INSUMO, true) ?>" placeholder="<?php echo i18n::__('EnterTheDescriptionOfTheInput') ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="<?php echo insumoTableClass::getNameField(insumoTableClass::PRECIO, true) ?>" class="col-lg-2 control-label" ><?php echo i18n::__('price') ?>:</label>
            <div class="col-lg-10">
                <input type="text" class="form-control" value="<?php echo ((isset($objInsu) == true) ? $objInsu[0]->$precio : '') ?>" id="<?php echo insumoTableClass::getNameField(insumoTableClass::PRECIO, true) ?>" type="text" class="frm-control" name="<?php echo insumoTableClass::getNameField(insumoTableClass::PRECIO, true) ?>" placeholder="<?php echo i18n::__('EnterThePrice') ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="<?php echo insumoTableClass::getNameField(insumoTableClass::ID, TRUE) ?>" class="col-lg-2 control-label"><?php echo i18n::__('idInput') ?>:</label>
            <div class="col-lg-10">
