...
<div class="container container-fluid">
    ...
    <div class="page-header titulo">
        <h1><i class="glyphicon glyphicon-road"> <?php echo i18n::__('juiceProcess') ?></i></h1>
        </div>
        ...
        <div class="modal-body">
          <form method="POST" class="form-horizontal" id="reportFilterForm" action="<?php echo routing::getInstance()->getUrlWeb('jugo', 'report') ?>">
            <div class="form-group">
              <label for="reportfecha1" class="col-sm-2 control-label"><?php echo i18n::__('date') ?></label>
              <div class="col-sm-10">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" role="form" class="form-horizontal" id="filterForm" action="<?php echo routing::getInstance()->getUrlWeb('jugo', 'index') ?>">
            <div class="form-group">
              <label for="filterfecha1" class="col-sm-2 control-label"><?php echo i18n::__('date') ?></label>
              <div class="col-sm-10">
                <input type="date" name="filter[fecha1]" class="form-control" id="filterCreacion1" placeholder="<?php echo i18n::__('date') ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="filterFecha1" class="col-sm-2 control-label"><?php echo i18n::__('date') ?></label>
              <div class="col-sm-10">
                <input type="date" name="filter[fecha2]" class="form-control" id="filterCreacion2" placeholder="<?php echo i18n::__('date') ?>">
              </div>
            </div>
            <div class="form-group">
