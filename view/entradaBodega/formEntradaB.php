...
<div class="container container-fluid">    
    ...
    <?php view::includeHandlerMessage() ?>
           <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="datetime-local" class="form-control" value="<?php echo ((isset($objEntradaBodega) == true) ? $objEntradaBodega[0]->$fechaE : '') ?>" type="text" class="frm-control" id="<?php echo entradaBodegaTableClass::getNameField(entradaBodegaTableClass::FECHA, true) ?>" name="<?php echo entradaBodegaTableClass::getNameField(entradaBodegaTableClass::FECHA, true) ?>" >
            </div>
        </div>
            <div class="form-group">
                <label for="<?php echo entradaBodegaTableClass::getNameField(entradaBodegaTableClass::PROVEEDOR_ID, TRUE) ?>" class="col-lg-2 control-label"><?php echo i18n::__('idProvider') ?>:</label>
            <div class="col-lg-10">
