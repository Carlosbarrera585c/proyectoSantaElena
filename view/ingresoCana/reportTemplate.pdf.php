...
$pdf->Cell(255,10,'INGRESO CAÑA',1,1,'C');
  ...
  $pdf->Cell(17,10,  utf8_decode("PROCEDENCIA"),1);
  $pdf->Cell(17,10,  utf8_decode("PESO_CAÑA"),1);
  $pdf->Cell(17,10,  utf8_decode("NUM_VAGON"),1);
...
foreach ($objingresoCana as $ingreso){
  ...
  $pdf->Cell(32,10,  utf8_decode($ingreso->$empleado_id),1);
  $pdf->Cell(35,10,  utf8_decode($ingreso->$proveedor_id),1);
  $pdf->Cell(20,10,  utf8_decode($ingreso->$cantidad),1);
  $pdf->Cell(17,10,  utf8_decode($ingreso->$procedencia_caña),1);
  $pdf->Cell(17,10,  utf8_decode($ingreso->$peso_caña),1);
  $pdf->Cell(17,10,  utf8_decode($ingreso->$num_vagon),1);
