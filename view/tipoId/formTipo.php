...
<form method="post" action="<?php echo routing::getInstance()->getUrlWeb('tipoId', ((isset($objTipoId) ) ? 'update' : 'create')) ?>">
    ...
    <div class="container container-fluid">
        ...
        <div class="col-lg-12 col-xs-offset-6">
            <input class="btn btn-success btn-xs" type="submit" value="<?php echo i18n::__(((isset($objTipoId)) ? 'update' : 'register')) ?>"> 
            <a href="<?php echo routing::getInstance()->getUrlWeb('tipoId', 'index') ?>" class="btn btn-info btn-xs"><?php echo i18n::__('back') ?></a></th>
        </div>
