 ...
 */
class tipoPagoBaseTableClass extends tableBaseClass {

    private $id;
    private $desc_tipo_pago;

    const ID = 'id';
    const DESC_TIPO_PAGO = 'desc_tipo_pago';
    ...
    function getdesc_tipo_pago() {
        return $this->desc_tipo_pago;
    }
    ...
    function setdesc_tipo_pago($desc_tipo_pago) {
