...
class tipoInsumoBaseTableClass extends tableBaseClass {
    ...
    function getDesc_tipo_insumo() {
        return $this->desc_tipo_insumo;
    }
    ...
    function setDesc_tipo_insumo($desc_tipo_insumo) {
        $this->desc_tipo_insumo = $desc_tipo_insumo;
    }
