...
class updateActionClass extends controllerClass implements controllerActionInterface {
  ...
  public function execute() {
    try {
      if (request::getInstance()->isMethod('POST')) {
        ...
        $this->ValidateUpdate($fecha, $numBache, $turno, $empleadoId, $proveedorId, $brix, $phDiluido, $phClarificado, $calDosificada, $floculante);
        ...
        clarificacionTableClass::update($ids, $data);
      }
      session::getInstance()->setSuccess(i18n::__('successfulUpdate'));
      session::getInstance()->setAttribute('form_' . clarificacionTableClass::getNameTable(), null);
  ...
  private function ValidateUpdate($fecha, $numBache, $turno, $empleadoId, $proveedorId, $brix, $phDiluido, $phClarificado, $calDosificada, $floculante) {
    $bandera = FALSE;
    ...
    if ($bandera === true) {
      ...
      request::getInstance()->addParamGet(array(clarificacionTableClass::ID => request::getInstance()->getPost(clarificacionTableClass::getNameField(clarificacionTableClass::ID, TRUE))));
      routing::getInstance()->forward('clarificacion', 'edit');
    }
  }
