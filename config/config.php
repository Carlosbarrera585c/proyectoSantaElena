...
config::setUrlBase('http://www.petete.com/');
...
config::setCookiePath('/www.petete.com/web/' . config::getIndexFile());
//Virtual Host
...
config::setCookieDomain('http://www.petete.com/');
